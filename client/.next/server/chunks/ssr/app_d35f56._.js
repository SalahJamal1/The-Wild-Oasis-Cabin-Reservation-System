...
function AccountForm() {
    ...
    const { SetAuth, Setuser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_components$2f$ReservationContext$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useReservation"])();
    const handelSubmit = async (e)=>{
        e.preventDefault();
        if (!email && !password) return;
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$apiService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Login"])({
                email,
                password
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success("Login Successfully");
            Setuser(res.user);
            SetAuth(true);
            router.push("/account");
        } catch (err) {
            console.log(err);
            if (err?.response?.data?.message) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(err.response.data.message);
...
//# sourceMappingURL=app_d35f56._.js.map